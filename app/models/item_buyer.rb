class ItemBuyer
  ...
  def save
    ...
    Address.create(zip_code: zip_code, ship_from_area_id: ship_from_area_id, city: city, address_line_1: address_line_1,
                   address_line_2: address_line_2, phone_number: phone_number, buyer_id: buyer.id)
  end
end
